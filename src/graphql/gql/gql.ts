...
const documents = {
    ...
    "mutation CreateResumeItem {\n  createResumeItem(\n    data: {contact: {id: \"\"}, education: {id: \"\"}, employment: {id: \"\"}, course: {id: \"\"}, languages: {id: \"\"}, links: {id: \"\"}, titles: {id: \"\"}}\n  ) {\n    data {\n      id\n    }\n  }\n}": types.CreateResumeItemDocument,
    ...
    "query Privacy($locale: I18NLocaleCode) {\n  pages(locale: $locale, filters: {slug: {eq: \"privacy\"}}) {\n    data {\n      attributes {\n        description\n        title\n      }\n    }\n  }\n}": types.PrivacyDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query Privacy($locale: I18NLocaleCode) {\n  pages(locale: $locale, filters: {slug: {eq: \"privacy\"}}) {\n    data {\n      attributes {\n        description\n        title\n      }\n    }\n  }\n}"): (typeof documents)["query Privacy($locale: I18NLocaleCode) {\n  pages(locale: $locale, filters: {slug: {eq: \"privacy\"}}) {\n    data {\n      attributes {\n        description\n        title\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
